   ...
   data:{
      ...
      datasets: [
      {
         data:[-2.61,-1.44,1.78,-1.08,-0.17,-1.30,-4.25,6.9,-1.35,-2.02,
	        ...
	        3.07,-0.55,-2.55,14.5,-2.39,-1.72,0.52],
         borderWidth:1,
         borderColor:[r_bor,r_bor,g_bor,r_bor,r_bor,r_bor,r_bor,g_bor,r_bor,r_bor,
		      ...
		      g_bor,g_bor,r_bor,r_bor,g_bor,r_bor,g_bor,r_bor,g_bor,r_bor,
		      g_bor,r_bor,r_bor,g_bor,r_bor,r_bor,g_bor],
         backgroundColor:[r_back,r_back,g_back,r_back,r_back,r_back,r_back,g_back,r_back,r_back,
			  ...
			  g_back,r_back,r_back,g_back,r_back,r_back,g_back],
      },
      ],
   },
    options: {
